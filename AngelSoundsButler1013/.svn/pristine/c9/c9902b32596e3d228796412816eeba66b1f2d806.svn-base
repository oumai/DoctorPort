...
-(void)makeUI
{
    table = [[UITableView alloc]initWithFrame:CGRectMake(0, 74, self.view.frame.size.width, self.view.frame.size.height-74)style:UITableViewStylePlain];
    table.delegate = self;
...
-(UITableViewCell*)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    [cell.tupian sd_setImageWithURL:[NSURL URLWithString:[dic objectForKey:@"resultImgUrl"]] placeholderImage:nil completed:^(UIImage *image, NSError *error, SDImageCacheType cacheType, NSURL *imageURL) {
    }];

...
-(void)createTB{
    self.myTB=[[UITableView alloc]initWithFrame:CGRectMake(0, 64, self.view.frame.size.width, self.view.frame.size.height-64) style:UITableViewStyleGrouped];
...
-(UIView*)tableView:(UITableView *)tableView viewForHeaderInSection:(NSInteger)section{
    ...
    //日期
    UILabel *timeLabel0=[[UILabel alloc]initWithFrame:CGRectMake(76, 73, 36, 14)];
    timeLabel0.font=[UIFont systemFontOfSize:TEXT_FONT];
    timeLabel0.text=@"日期:";
    [headerView addSubview:timeLabel0];
    
    UILabel *timeLabel=[[UILabel alloc]initWithFrame:CGRectMake(114, 73, 198, 14)];

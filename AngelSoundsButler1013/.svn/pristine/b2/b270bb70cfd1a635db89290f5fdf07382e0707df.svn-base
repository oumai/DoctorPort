...
//
//
#define kGetPushMessageList @"jumper.doctor.testRecord.testRecordList" //健康管理
#define kGetAppVersion @"jumper.doctor.testRecord.searchRecord"  //搜索健康数据
    ...
    for (int i = 0 ; i < arr.count+1; i++) {
        ...
        [cell.diview addSubview:view2];
            ...
            else
            {
                ...
                {
                    UIImageView *imagveiw = [[UIImageView alloc]initWithFrame:CGRectMake(10, 10, 21, 20)];
                    imagveiw.image = [UIImage imageNamed:@"health_manage_bloodpressure"];
                    [view2 addSubview:imagveiw];

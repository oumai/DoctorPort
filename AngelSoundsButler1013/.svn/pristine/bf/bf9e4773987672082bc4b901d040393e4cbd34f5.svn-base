...
-(void)makeUI
{
    table = [[UITableView alloc]initWithFrame:CGRectMake(0, 74, self.view.frame.size.width, kSCREEN_HEIGHT-74)style:UITableViewStylePlain];
    table.delegate = self;
...
-(void)setque
{
    ...
    NSDictionary *json = @{@"user_id":str,@"page_index":index,@"page_size":@"10"};

...
- (UIImageView *)arrowImage
{
    if (!_arrowImage) {
        ...
        UIImageView *arrowImage = [[UIImageView alloc] initWithImage:[UIImage imageNamed:@"2.gif"]];
        arrowImage.frame = CGRectMake(20, 20, 30, 30) ;
        [arrowImage setAnimationImages:[NSArray arrayWithObjects:[UIImage imageNamed:@"1"],[UIImage imageNamed:@"2"],[UIImage imageNamed:@"3"],[UIImage imageNamed:@"3"],[UIImage imageNamed:@"4"],[UIImage imageNamed:@"5"],[UIImage imageNamed:@"6"],[UIImage imageNamed:@"7"],[UIImage imageNamed:@"8"],[UIImage imageNamed:@"9"],[UIImage imageNamed:@"10"],[UIImage imageNamed:@"11"],[UIImage imageNamed:@"12"],nil]];
